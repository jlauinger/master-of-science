...
\begin{lstlisting}[language=Golang, label=lst:escape-analysis, caption=Escape analysis flaw example, float, belowskip=-1.5em, aboveskip=0em]
func main() {
...
\new{Furthermore, an in-depth write-up about exploiting \unsafe{} issues in Go exists as a series of blog articles\footurl{https://dev.to/jlauinger/exploitation-exercise-with-unsafe-pointer-in-go-information-leak-part-1-1kga}.}
