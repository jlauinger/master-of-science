...
\begin{document}
    ...
    \author{\IEEEauthorblockN{Johannes Lauinger}
        \IEEEauthorblockA{Software Technology Group\\TU Darmstadt}
        \and
        \IEEEauthorblockN{Anna-Katharina Wickert}
        \IEEEauthorblockA{Software Technology Group\\TU Darmstadt}
        \and
        \IEEEauthorblockN{Lars Baumgärtner}
        \IEEEauthorblockA{Software Technology Group\\TU Darmstadt}
        \and
        \IEEEauthorblockN{Mira Mezini}
        \IEEEauthorblockA{Software Technology Group\\TU Darmstadt}
    }
