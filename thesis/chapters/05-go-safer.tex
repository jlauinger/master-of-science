...
both using the labeled data set of \unsafe{} usages presented in the previous chapter and a manual analysis of \checkNum{six}
...
To run it, append the package names that should be checked as parameters.
...
If it is the case, then the assignment is legitimate and \toolSafer{} does not print a warning.
