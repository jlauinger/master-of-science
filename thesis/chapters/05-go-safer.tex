...
The \textit{sliceheader} analysis pass first receives the \acrshort{AST} and filters it for composite literals
(\textit{CompositeLit} nodes) and assignment statements (\textit{AssignStmt} nodes).
