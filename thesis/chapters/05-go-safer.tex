...
\textit{uintptr}.
These \checkNum{three} basic types are the ones available in Go that have different sizes and byte orders on varying
architectures.
...
\begin{hero}[Evaluation on labeled usages]
...
\begin{hero}[Evaluation on case study packages]
