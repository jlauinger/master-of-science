...
Red lines are packages that directly contain \unsafe{} code, and white lines indicate that the package does not
contain \unsafe{} usages itself but instead introduces them through its dependencies.
...
These steps are done using the \acrshort{AST} inspection \acrshort{API} that is provided as part of the Go programming
language\footnote{\url{https://golang.org/pkg/go/ast/}}.
