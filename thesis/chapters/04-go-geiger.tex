...
conduct a focused review of the \unsafe{} code.
...
(\sysModuleUnsafeIncrease) over the period shown in the figure, which is from \checkNum{2017} to \checkNum{May 2020}
(\checkNum{2.5 years}).
...
for the specific version that is imported in an application.
...
\checkNum{a third} directly contains \unsafe{}, almost all of them import \unsafe{} code through their dependencies.
...
It showed that the most common usecases are increasing efficiency by avoiding memory reallocations when converting
