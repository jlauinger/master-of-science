...
To evaluate \toolGeiger{} on real-world data, it is used to gather empirical data about the usage of \unsafe{} in
...
The data set contains \checkNum{XX} unique \unsafe{} usages in \packagesAnalyzed{} packages.
