...
There are \checkNum{25} projects for which~\cite{costa2020} reports \unsafe{} usages  but my study does not.
...
There are \checkNum{86} projects for which the study in this thesis and~\cite{costa2020} reported different absolute
...
\checkNum{October 2019} and \checkNum{May 2020}, which was when the project data set for this thesis was collected.
