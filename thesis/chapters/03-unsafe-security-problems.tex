...
\input{assets/figures/chapter3/outline.tex}
...
\input{assets/listings/chapter3/todo-unsafe-snippet.tex}
...
\input{assets/listings/chapter3/no-escape-function.tex}

Is the identified unsafe cast pattern safe if it is done in one statement?

\input{assets/listings/chapter3/cast-1-statement.tex}
